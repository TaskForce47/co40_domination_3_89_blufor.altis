...
if (_unit getVariable ["xr_ReviveAction", -9999] == -9999) then {
	private _id = [
		/* 0 object */						_unit,
		/* 1 action title */				format ["<t color='#FF0000'>%1 %2</t>", if (xr_pl_can_revive) then {localize "STR_DOM_MISSIONSTRING_923"} else {localize "STR_DOM_MISSIONSTRING_924"}, _unit call d_fnc_getplayername],
