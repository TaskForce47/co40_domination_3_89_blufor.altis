...
SERVICEPOINT_LOADOUT_ADD_ITEM("ACE_EarPlugs",2)
SERVICEPOINT_LOADOUT_ADD_ITEM("Binocular",1)
SERVICEPOINT_LOADOUT_ADD_ITEM("tf_anprc152",2)
...
SERVICEPOINT_LOADOUT_ADD_ITEM("tf_anprc152",4)
