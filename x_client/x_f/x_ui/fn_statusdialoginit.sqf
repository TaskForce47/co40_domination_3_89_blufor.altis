...
__ctrl2(2001) ctrlSetText str(d_points_needed select 0);
__ctrl2(2002) ctrlSetText str(d_points_needed select 1);
__ctrl2(2003) ctrlSetText str(d_points_needed select 2);
__ctrl2(2004) ctrlSetText str(d_points_needed select 3);
__ctrl2(2005) ctrlSetText str(d_points_needed select 4);
__ctrl2(2006) ctrlSetText str(d_points_needed select 5);
__ctrl2(2011) ctrlSetText str(d_points_needed select 6);
